...
charShift_H:
    lda     $151a           ; Get the high address byte
    sta     $151d           ; Store in the second ROR address byte

    lda     $1519           ; Get the low address byte
    ora     #$08            ; Add 8 to the low address byte (Since the linked character is stored at $***0)
    sta     $151c           ; Store in the first ROR address byte

    lda     $1518           ; Get the instruction byte
    sta     $151b           ; Store in the instruction byte
